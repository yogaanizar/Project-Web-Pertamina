<?php 
    ...
    if($_SESSION['status']!="login"){
      header("location:../../page-menu/login/login.php?pesan=belum_login");
    }
...
<html>
  <div class="content-wrapper">
    ...
    <div class="card card-primary ml-4 mr-4">
      ...
      <div class="card-body">
      <form id="quickForm" method="post" action="setEdit.php?kd_asset=<?php echo $kode_asset ?>" enctype="multipart/form-data">
          <div class="row">
            <div class="col-sm-6">
