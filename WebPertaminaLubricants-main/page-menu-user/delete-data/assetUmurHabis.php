...
<html>
  <div class="content-wrapper">
    ...
    <?php
      ...
      if($button == 'UHOC'){
        $sql = "SELECT * FROM `asset_waktu_habis`WHERE id_kantor = 'OC'";
      }elseif($button == 'UHPUC'){
        $sql = "SELECT * FROM `asset_waktu_habis`WHERE id_kantor = 'PUC'";
      }elseif($button == 'UHPUG'){
        $sql = "SELECT * FROM `asset_waktu_habis`WHERE id_kantor = 'PUG'";
      }elseif($button == 'UHPUJ'){
    ...
    ?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-dark">
                <i class="fa-solid fa-clock-rotate-left"></i> Asset Umur Habis
              </div>
              <div class="card-body">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        ?>
                          <center>
                            <button class="btn-success btn-md btn">
                        ...
                        ?>
                        <center>
                          <button class="btn-danger btn-md" data-toggle="modal" data-target="#modalHapus<?php echo $row["kode_asset"]?>">
      ...
      ?>
          <div class="mt-5">
              <center><h4>Tidak ada Asset Umur Habis</h4></center>
          </div> 
      <?php   
        }
        $conn->close();
