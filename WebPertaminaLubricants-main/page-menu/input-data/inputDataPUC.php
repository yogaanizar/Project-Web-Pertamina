...
<html>
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../list-kantor/PUC.php">Production Unit Cilacap</a></li>
    ...
    <div class="card card-primary ml-3 mr-3">
      ...
      <i class="fa-solid fa-pen-to-square fa-lg"></i> Form Pengisian Asset Baru "Production Unit Cilacap"
      </div>
      <div class="card-body">
      ...
      <div class="card-footer">
        <button type="submit" class="btn btn-primary " value="inputPUC" name="button">Submit</button>
      </div>
    </div>
    </form>
</html>
