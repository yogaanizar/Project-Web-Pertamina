    ...
    <div class="row ml-2 mr-2">
      <div class="col-md-6">
        <div class="card">
          ...
          <?php
            $sqlpelihara = "SELECT * FROM `asset_pemeliharaan`";
            $maintenance = $conn->query($sqlpelihara);
            $totalMaintenance = mysqli_num_rows($maintenance);
          ?>
          <div class="card-body">
            <a href="../maintenance/maintenance.php? btn=MInventaris">
                ...
                <table class="table table-bordered table-striped table-responsive">
                  <thead>
                    <tr class="bg-primary">
                      ...
                      <th><h6 align="center"><b>Maintenance</b></h6></th>
                  ...
                  <tbody>
                      ...
                      <td>
                        ...
                        <div class="mt-2">
                          <center>
                            <button class="btn btn-danger btn-md"  data-toggle="modal" data-target="#modalHapus<?php echo $row["kode_asset"]?>">
