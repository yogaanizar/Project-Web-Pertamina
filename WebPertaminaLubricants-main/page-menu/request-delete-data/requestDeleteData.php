  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Request Penghapusan Asset</h1>
          </div>
          <div class="col-sm-6">
    ...
    <?php
      ...
      $previous = $halaman - 1;
      $next = $halaman + 1;
      $sql = "SELECT * FROM `asset_inventaris` WHERE status_request_hapus = 1";
      $result = $conn->query($sql);
      $total = mysqli_num_rows($result);
      $total_halaman = ceil($total / $batas);
      $data_asset = mysqli_query($conn,"SELECT * FROM `asset_inventaris` WHERE status_request_hapus = 1 limit $halaman_awal, $batas");
      $no = $halaman_awal+1;
    ...
    ?>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <p><h5>Setujui Untuk Menghapus Asset "<?php echo  $row["deskripsi_asset"] ?>" ?</h5></p>
                                  </div>
                                  <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                                    <a href="delete.php? kode_asset=<?=$row["kode_asset"]?>&button=hapusData">
      ...
      ?>
          <div class="mt-5">
              <center><h4>Tidak ada Request Asset untuk Dihapus</h4></center>
          </div> 
      <?php   
        }
        $conn->close();
