    ...
    <div class="row ml-2 mr-2">
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <a href="../input-data/inputDataPUJ.php">
          ...
          <?php
            $sqlpelihara = "SELECT * FROM `asset_pemeliharaan` WHERE id_kantor = 'PUJ'";
            $maintenance = $conn->query($sqlpelihara);
            $totalMaintenance = mysqli_num_rows($maintenance);
          ?>
          <div class="card-body">
            <a href="../maintenance/maintenance.php? btn=MPUJ">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-dark">
                <i class="fa-solid fa-coins fa-lg"></i> Production Unit Jakarta
              </div>
              <div class="card-body">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div>
                          <center>
                            <a href="../input-data/editAsset.php? kode_asset=<?=$row["kode_asset"]?>& btn=btnEditPUJ">
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-between">
                                  ...
                                  <a href="../delete-data/delete.php? kode_asset=<?=$row["kode_asset"]?>&button=hapusPUJ">
